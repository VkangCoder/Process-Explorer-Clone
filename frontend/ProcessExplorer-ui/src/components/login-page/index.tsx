...
import { LockKeyhole, RectangleEllipsis, User2 } from "lucide-react";
    ...
    return (
        <div className={styles.loginPage} style={cssVars}>
            <Card className={styles.card}>
                ...
                <Form<LoginFormValues> layout="vertical" onFinish={handleFinish} disabled={isLoggingIn}>
                    <Form.Item
                        name="username"
                        label={
                            <>
                                <User2 size={14} style={{ marginRight: 8 }} /> User name
                            </>
                        }
                    ...
                    <Form.Item
                        ...
                        label={
                            <>
                                <RectangleEllipsis size={14} style={{ marginRight: 8 }} /> Password
                            </>
                        }
