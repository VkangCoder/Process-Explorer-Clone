...
static class ProcessTreeNative
{
    ...
    public static Dictionary<int, (int parent, int threads)> GetParentMap()
    {
        var map = new Dictionary<int, (int parent, int threads)>();
        ...
        try
        {
            ...
            do
            {
                map[(int)entry.th32ProcessID] = ((int)entry.th32ParentProcessID, (int)entry.cntThreads);
            }
